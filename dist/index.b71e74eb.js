...
const costButton = document.getElementById('cost-btn');
...
searchButton.addEventListener('click', async ()=>{
    ...
    try {
        const response = await (0, _axiosDefault.default).post(apiBaseUrl + '/package/byRegEx', {
            RegEx: query
        });
...
submitButton.addEventListener('click', async ()=>{
    ...
    try {
        let response;
        if (currentEndpoint.includes('{id}')) response = await (0, _axiosDefault.default).get(`${apiBaseUrl}${currentEndpoint.replace('{id}', input)}`);
        else response = await (0, _axiosDefault.default).post(`${apiBaseUrl}${currentEndpoint}`, {
            input
        });
        displayResponse(response.data);
    } catch (error) {
        if ((0, _axiosDefault.default).isAxiosError(error)) {
            if (error.response?.status === 404) displayResponse('Error 404: Package not found.');
            else if (error.response?.status === 400) displayResponse('Error 400: There is missing field(s) in the PackageID');
            else displayResponse('Error 500: The package rating system choken on at least one of the metrics.');
        } else displayResponse(String(error));
    }
});
...
},{"adfd9b103875c2dd":"9XjFm","../utils.js":"5By4s","../core/AxiosError.js":"3u8Tl","../platform/node/classes/FormData.js":"aFlee","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9XjFm":[function(require,module,exports,__globalThis) {
/*!
...
},{"8d7b0712b5ea2b3":"nW5AX","603aed6e39afb648":"cPS8K"}],"nW5AX":[function(require,module,exports,__globalThis) {
'use strict';
...
},{}],"cPS8K":[function(require,module,exports,__globalThis) {
